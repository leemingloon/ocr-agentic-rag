...
PRIMER_CATALOGUE: list[dict] = [
    ...
    },
    {
        "section": 2,
        "section_title": None,
        "name": "TABLE_SEGMENT_ALIGNMENT_PRIMER",
        "intent_label": "table_segment_alignment",
        "trigger": "OCR-flattened segment tables; portion/share of total by segment",
        "standard": "FinQA HII/2018 Ingalls backlog portion",
        "rationale": "Align segment and total by relative position; use second aligned pair when no year specified.",
        "content": TABLE_SEGMENT_ALIGNMENT_PRIMER,
    },
    {
        "section": 2,
        "section_title": None,
        "name": "TABLE_ROW_ALIGNMENT_PRIMER",
        "intent_label": "table_row_alignment",
        "trigger": "Multi-year tables; portion/ratio when question does not specify year",
        "standard": "Standard tables with visible year labels",
        "rationale": "Numerator and denominator from same row pair; prefer earlier year when ambiguous.",
        "content": TABLE_ROW_ALIGNMENT_PRIMER,
    },
    {
        "section": 2,
        "section_title": None,
