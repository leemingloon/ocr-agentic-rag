...
| **3-tier OCR fallback** | Balances cost, speed, and accuracy: cache → classical → DL -> Vision-Language. Classical for text recognition, DL for table recognition, Vision (multi-modal) fallback for charts or diagrams understanding. |
