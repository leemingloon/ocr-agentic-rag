...
- **Credit risk:** ipynb files in [notebooks/](notebooks/) [Completed]
  ...
  - PD predictions in [data/proof/credit_risk_pd/](data/proof/credit_risk_pd/) on Hugging Face pre-defined splits (train/valid/test) with AUC scores across different models (Optuna-tuned or not):
    - [tuned-XGB/untuned-LGB stack](data/proof/credit_risk_pd/lendingclub/lendingclub_avg.json) (Selected stack for tree-based models)
